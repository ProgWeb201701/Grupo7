...
require_once('../Controller/ctrlAvaliacao.php');

$dados_post = $_POST;

$ctrl = ctrlAvaliacao::getInstancia();

$ctrl->gravaPropriedade($dados_post);
...
<form action="compilaDados.php" method="post">
...
<tr>
    ...
    <td>
        ...
        <input type="radio" name="obs191" value="Zootecnista"> Zootecnista <br>
